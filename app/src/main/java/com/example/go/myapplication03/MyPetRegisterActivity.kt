                ...
                builder02.setTitle("정보 저장 확인")
                    ...
                    .setPositiveButton("확인",
                        DialogInterface.OnClickListener { dialog, id ->
                            ...
                            //indogimage
                            //-----debug용 확인 코드---------------
                            val inputStream: InputStream = resources.openRawResource(R.drawable.dog_picture05)
                            ...
                            val requestBodyProfile = RequestBody.create(
                                MediaType.parse("image/jpeg"),bitmap01toFile
                            )
                            // 실제 전송할 수 있는 데이터 형태를 만든다.
                            val multipartBodyProfile = MultipartBody.Part.createFormData(
                                "file", bitmap01toFile!!.name, requestBodyProfile
                            )
