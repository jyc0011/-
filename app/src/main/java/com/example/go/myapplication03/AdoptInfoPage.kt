...
class AdoptInfoPage : AppCompatActivity() {
    private val loadingDialog: LoadingDialog = LoadingDialog(this@AdoptInfoPage)

    private lateinit var dogItems_list: MutableList<DataModel02.DogItem>
    private lateinit var recyclerView: RecyclerView
    private lateinit var adapter: AdoptInfoPage.DogAdapter
    lateinit var nodebaseurl : String
    lateinit var mRetrofit: Retrofit
    lateinit var mRetrofitAPI: RetrofitAPI
    override fun onCreate(savedInstanceState: Bundle?) {
        nodebaseurl = intent.getStringExtra("nodebaseurl") ?: ""
        setRetrofit()

        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_adopt_info_page)
        ...
        mRetrofitAPI.adoptingdogallsearch().enqueue(object :
            ...
            override fun onFailure(call: Call<DataModel02.Mydog_all_search_result>, t: Throwable) {
                ...
                val intent0001 = Intent(this@AdoptInfoPage,Mainservicepage::class.java)
        ...
        inner class DogViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
            ...
            init {
                dogButton.setOnClickListener {
                    ...
                    val intent = Intent(context, AdoptInfoCheck::class.java) // Replace with your new activity class
