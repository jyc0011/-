...
class nodePing {
    ...
    suspend fun onCreate() = withContext(Dispatchers.IO) {
        val nodes = listOf("13.51.87.180", "3.37.158.247")
        ...
        val baseUrl = listOf("http://13.51.87.180:5000", "http://3.37.158.247:5000")
                ...
                override fun onResponse(
                    ...
                    if (response.isSuccessful) {
                        ...
                        if (tokenResponse != null) {
                            Results.add(tokenResponse)
                            val tokenMessage = tokenResponse
                    ...
                    if (Results.size == baseUrl.size) {
                        ...
                        largestValueNode = "http://192.168.9.242:5000"
